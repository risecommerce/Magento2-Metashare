<?php
namespace Risecommerce\MetaSharing\Block;
...
class MetaBlocks extends \Magento\Framework\View\Element\Template
{
    ...
    const FACEBOOK_USERNAME = 'metashare/facebook_meta_share_options/facebook_username';
    const INSTAGRAM_USERNAME = 'metashare/instagram_meta_share_options/instagram_username';
    ...
    const INSTAGRAM_IMAGE = 'metashare/instagram_meta_share_options/instagram_default_image';
    const INSTAGRAM_ENABLED = 'metashare/instagram_meta_share_options/enable_disable_instagram_tags';
